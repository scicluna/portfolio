...
export default function About() {
    return (
        <section className="h-full flex flex-col md:flex-row items-center sm:justify-between sm:m-5 m-1" >
            <img src="./src/imgs/me.webp" alt="A picture of myself!" className="sm:w-96 w-full " />
            <div>
                <PictureFan />
            </div>
            <p className="sm:w-96 w-full pb-10">Hello, my name is John Lucas Scicluna, but those who know me call me Luke. Other than my career
